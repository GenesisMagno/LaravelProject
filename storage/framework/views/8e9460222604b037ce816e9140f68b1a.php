...
unset($__errorArgs, $__bag); ?>
 ...
 <!-- Google Login Button -->
 <a href="<?php echo e(route('login.google')); ?>" class="w-full block bg-white hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-4 py-2 border border-gray-300 mt-4">
