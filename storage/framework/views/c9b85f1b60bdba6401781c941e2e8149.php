...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div id="input-Container" class="w-[35%] h-full pt-8 block">
                            <div class="mb-4  flex flex-col">
                                ...
                                <input type="text" name="name" id="name" class="rounded-md h-10 w-4/5 text-xl border border-black mt-2 px-6 m-auto" value="<?php echo e($product->name); ?>">
...
<?php endif; ?><?php /**PATH D:\Xampp\htdocs\dashboard\LaravelProject\resources\views/admin/adminUpdate.blade.php ENDPATH**/ ?>