...
<form action="{{ route('login.store') }}" method="POST">
 ...
 <!-- Google Login Button -->
 <a href="{{ route('login.google') }}" class="w-full block bg-white hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-4 py-2 border border-gray-300 mt-4">
